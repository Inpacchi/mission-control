...
- [TUI hook patterns (post-refactor)](project_tui_hook_patterns.md) — Naming conventions (detail* prefix), RARITY_INK_COLOR location, MarkdownPanel lines-vs-content, useDetailSearch hook, cache guard pattern, filteredEntries vs entries index, rules-of-hooks in presentational components, return false after consumed check.
